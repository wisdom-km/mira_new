// FileDialog: Public or internal interface for the DirectorDesk Platform module.
...
public:
    ...
    static Core::Result<std::string> OpenJsonFile();
    ...
    static Core::Result<std::string> SavePdfFile(const std::string& defaultName);
};
