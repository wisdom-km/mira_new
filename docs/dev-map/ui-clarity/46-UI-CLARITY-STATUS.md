...
| 最后更新 | 2026-09-14 |
| 更新者 | Cursor AI |
| 下一个允许执行的工作 | U1 其余等对应 `FND-xx`；UIC-32 等 F2。F1 下一代码行是 FND-16 |
| 当前波次 | U0 已收口；UIC-20 / 23 / 25 / 27 / 30 / 31 / 33 / 34 已写入；U1 其余未开 |
...
| UIC-22 | 剧本行高亮 | 未开始 | FND-15 已给 `Shot.lineStart/lineEnd`；`scriptSelectedLineStart/End` 仍等本行 |
