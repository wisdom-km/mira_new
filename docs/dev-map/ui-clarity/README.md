...
> 当前阶段：**U0 已完成**，**UIC-20 / 27 / 30 / 31 / 33 / 34** 已随 **`v0.1.3`** 入库。进度以 [`46`](46-UI-CLARITY-STATUS.md) 为准。U1 其余等对应 `FND-xx`。
...
| 不允许改 | 模块集合、区域 ID、窗口 `###` 后缀、`.ddproj` 版本、AI 冻结 |
...
- [`40-UI-AUDIT-AND-REDESIGN.md`](40-UI-AUDIT-AND-REDESIGN.md) — 审计证据、原则、Q1–Q10 原文
- [`43-CONTRACT-DELTA.md`](43-CONTRACT-DELTA.md) — 2 个 Command、快照、色板、字号、图标
- [`44-LANDING-CHECKLIST.md`](44-LANDING-CHECKLIST.md) — U0 / U1 / U2 任务表
