...
| 最后更新 | 2026-09-13 |
| 更新者 | Cursor AI |
| 下一个允许执行的工作 | **F0 · FND-02**（shader 按平台裁剪）。F0 全部完成且 CI 双绿之前不开 F1 |
| 当前波次 | F0 · 止血 |
...
| ID | 任务 | 状态 | 验证记录 |
|----|------|------|----------|
| FND-01 | Windows CI 生成器 | 已完成 | `ci.yml` 矩阵 `os: windows-2022`；`ci-windows` 仍用 VS 17 2022。未改 Ninja。Windows job 待 push 后确认全绿 |
| FND-02 | shader 按平台裁剪 | 未开始 | |
| FND-03 | `Ctrl+E` 用当前分辨率 | 未开始 | |
| FND-04 | 删索引不标脏 | 未开始 | |
| FND-05 | `ViewportResizeCommand` 只在变化时推 | 未开始 | |
| FND-06 | 统一 SHA-256 | 未开始 | |
| FND-07 | README 英文摘要 / 截图 / 30 秒上手 | 未开始 | |
| FND-08 | Issue / PR 模板 | 未开始 | |
| FND-09 | tag 触发 Release | 未开始 | |
...
| `.github/workflows/release.yml` | [`34`](34-LANDING-CHECKLIST.md) FND-09 | 未创建 |
