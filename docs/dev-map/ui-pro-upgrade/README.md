...
> 权威关系：`../00`–`../08` 仍是最高约束（依赖方向、模块数锁定、AI 以 07 当前落点为准）。本版当时冻结 AI；FOUNDATION F5 已解冻，以 `../00` / `../07` 为准。
...
| 不允许改 | 模块集合、依赖方向、领域规则所有权、`Application.cpp` 的文件切分（AI 以 FOUNDATION F5 / `../07` 为准） |
